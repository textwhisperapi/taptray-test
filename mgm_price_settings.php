...
$ctx = mgm_bootstrap('pricing', 'Price Settings');
...
function mgm_price_row(int $members, float $storageGb, float $unitPriceMember, float $unitPriceGb, float $discountBaseMembers, float $discountLogFactor, float $discountFloor): array {
...
mgm_render_shell_start(
    $ctx,
    'Price Settings',
    'This remains a preview page for pricing logic. It now lives inside the new management shell, but it still does not persist changes to the live billing configuration.'
);
?>
  <style>
    .panel {
    ...
    <div class="panel">
      ...
      <p>Management preview for TW pricing. Access is currently hardcoded to user <strong>grimmi</strong>.</p>
      ...
      <p class="hint">
        This page does not save anything yet. It is only the management UI shell and preview.
      </p>
    </div>
<?php
