...
$workerEndpoint = "https://r2-worker.textwhisper.workers.dev";
...
if (isset($_GET['name'])) {
    ...
    $uploadUrl = $workerEndpoint . "?name=" . rawurlencode($safeKey);
    ...
    echo json_encode([
        "status"   => "ok",
        "upload"   => $uploadUrl,   // POST to this
        "public"   => $publicUrl,   // permanent link
