TextWhisper — License Information

This project makes use of third-party libraries under MIT, ISC, and Apache 2.0 licenses.

- MIT License applies to: jQuery, Bootstrap, SortableJS, Tone.js, MidiPlayerJS, compactMidiPlayer.js
- ISC License applies to: Lucide Icons
- Apache License 2.0 applies to: PDF.js

Copies of MIT and ISC license texts are available at:
- https://opensource.org/licenses/MIT
- https://opensource.org/licenses/ISC

As required, the full text of the Apache License 2.0 is included below.
